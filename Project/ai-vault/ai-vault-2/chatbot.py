...
class MyChatbot:
    def __init__(self, user_name: str = "John Doe"):
        self.client = OpenAI()
        self.db = JsonDB()
    ...
    def chat(self, prompt: str) -> dict:
        ...
        response = self.client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": f"""You are a helpful assistant that can help me manage my passwords in a database. 
                    For security reasons, before performing any password-related operations (get/set/delete), 
                    you must first ask for and verify the user's name. Only proceed with password operations 
                    if they identify themselves correctly. The user's name is {self.user_name}.""",
                },
